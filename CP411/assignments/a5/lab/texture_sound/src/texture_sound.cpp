...
void init(void) {
	...
	Image* image = loadTexture("texture/sun.bmp");
	...
	image = loadTexture("texture/earth.bmp");
	...
	image = loadTexture("texture/moon.bmp");
...
void mainMenu(GLint option) {
	...
	case 8:
		...
		break;
	case 9:
		PlaySound((LPCSTR) "texture/test.wav", NULL, SND_FILENAME | SND_ASYNC);
		break;
	case 10:
